...
# Step 9, Step 8: creating data base called exactly osTicket and finish
- First I open heidisql,right click the dolphin image, create new, type osTicket, and fill in the rest of the osTicket database setting and finish the installation of osTicket. 
