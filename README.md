...
1. Macbook Pro running Windows 10 
...
After downloading the osTicket files on to my desktop from the checklist, I followed the video and extracted the folder with the actual documents from the zip folder and put that on my desktop then deleting the zip folder as the video said to.  
...
<img width="1084" height="668" alt="2   CONTROL PANAL" src="https://github.com/user-attachments/assets/6d54bfe7-b17d-4955-8cf2-46156c495f4f" /> </p>   
